...
INPUT_DIR = "D:/rag_project/graph_test/ragtest/inputs/artifacts"
...
async def setup_llm_and_embedder():
    ...
    llm = ChatOpenAI(
        ...
        # 调用本地大模型  通过Ollama
        api_base="http://192.168.1.24:3000/v1",  # 请求的API服务地址
        api_key="sk-g6IdAKQFm834SNK9B289E7CaBcA241A8A26eA821663c07Ac",  # API Key
        model="qwen-plus",  # 本次使用的模型
        api_type=OpenaiApiType.OpenAI,
    )
